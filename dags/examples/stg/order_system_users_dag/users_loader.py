...
class UsersLoader:
    ...
    WF_KEY = "order_system_users_origin_to_stg_workflow"
    LAST_LOADED_TS_KEY = "last_loaded_ts"

    def __init__(self, collection_loader: UsersReader, pg_dest: PgConnect, pg_saver: Pg_Saver_Users, logger: Logger) -> None:
